...
#test unsigned in users are redirected to the sign-in page, as they will not be allowed to vote on posts
     context "guest" do
...
#create a context to test signed-in users who should be allowed to vote on posts
     context "signed in user" do
       ...
       describe "POST up_vote" do
#we expect the first time a user up votes a post, a new vote is created for the post
...
#test to ensure users are redirected back to the correct view depending on which view they up voted from
